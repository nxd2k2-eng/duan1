<div class="col-lg-9 wow fadeInUp" data-wow-delay="0.1s">
    <div class="rounded mb-4 position-relative">
        <img src="assets/img/product-banner-3.jpg" class="img-fluid rounded w-100" style="height: 250px;" alt="Image">
    ...
    <div class="tab-content">
        <div id="tab-5" class="tab-pane fade show p-0 active">
            <div class="row g-4 product">
                <?php foreach ($productsAll['data']  as $product) : ?>
                    <div class="col-lg-4">
                            ...
                            <div class="product-item-inner border rounded">
                                ...
                                <div class="text-center rounded-bottom p-4">
                                    ...
                                    <?php if (!empty($product['sale_price'])): ?>
                                        <del class="text-primary fs-5"><?= htmlspecialchars(number_format($product['price'], 2)) ?></del>
                                        <span class="ms-2 text-danger fs-5"><?= htmlspecialchars(number_format($product['sale_price'], 2)) ?></span>
                                    <?php else: ?>
                                        <span class="text-primary fs-5"><?= htmlspecialchars(number_format($product['price'], 2)) ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
